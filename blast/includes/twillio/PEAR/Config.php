 ...
 */
require_once ABSPATH.'includes\twillio\PEAR.php';

require_once ABSPATH.'includes\twillio\PEAR\Registry.php';
require_once ABSPATH.'includes\twillio\PEAR\Installer/Role.php';
require_once ABSPATH.'includes\twillio\System.php';
    ...
    function readFTPConfigFile($path)
    {
        do { // poor man's try
            if (!class_exists('PEAR_FTP')) {
                ...
                if (PEAR_Common::isIncludeable(ABSPATH.'includes\twillio\PEAR\FTP.php')) {
                    require_once ABSPATH.'includes\twillio\PEAR\FTP.php';
                }
            }
    ...
    */
    ...
    function &getREST($version, $options = array())
    {
        ...
        if (!class_exists($class = 'PEAR_REST_' . $version)) {
            require_once ABSPATH.'includes\twillio\PEAR\REST/' . $version . '.php';
        }
