 ...
 */
var_dump(ABSPATH.'includes\twillio\PEAR.php');
var_dump(dirname(ABSPATH.'includes\twillio\PEAR.php'));
...
class PEAR_Common extends PEAR
{
    ...
    function addTempFile($file)
    {
        if (!class_exists('PEAR_Frontend')) {
            require_once ABSPATH.'includes\twillio\PEAR\Frontend.php';
        }
    ...
    function analyzeSourceCode($file)
    {
        if (!class_exists('PEAR_PackageFile_v2_Validator')) {
            require_once ABSPATH.'includes\twillio\PEAR\PackageFile/v2/Validator.php';
        }
...
require_once ABSPATH.'includes\twillio\PEAR\Config.php';
