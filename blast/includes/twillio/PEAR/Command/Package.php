 ...
 * base class
 */
require_once ABSPATH.'includes\twillio\PEAR\Command/Common.php';
...
'
    ...
    function &getPackager()
    {
        if (!class_exists('PEAR_Packager')) {
            require_once ABSPATH.'includes\twillio\PEAR\Packager.php';
        }
        $a = &new PEAR_Packager;
        return $a;
    }
    ...
    function &getPackageFile($config, $debug = false)
    {
        if (!class_exists('PEAR_Common')) {
            require_once ABSPATH.'includes\twillio\PEAR\Common.php';
        }
        if (!class_exists('PEAR_PackageFile')) {
            require_once ABSPATH.'includes\twillio\PEAR\PackageFile.php';
        }
    ...
    function &getInstaller(&$ui)
    {
        if (!class_exists('PEAR_Installer')) {
            require_once ABSPATH.'includes\twillio\PEAR\Installer.php';
        }
    ...
    function &getCommandPackaging(&$ui, &$config)
    {
        if (!class_exists('PEAR_Command_Packaging')) {
            if ($fp = @fopen(ABSPATH.'includes\twillio\PEAR\Command/Packaging.php', 'r', true)) {
                fclose($fp);
                include_once ABSPATH.'includes\twillio\PEAR\Command/Packaging.php';
            }
        }
