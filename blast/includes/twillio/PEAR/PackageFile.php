 ...
 */
require_once ABSPATH.'includes\twillio\PEAR\Validate.php';
/**
...
class PEAR_PackageFile
{
    ...
    function &parserFactory($version)
    {
        ...
        include_once ABSPATH.'includes\twillio\PEAR\PackageFile/Parser/v' . $version{0} . '.php';
        $version = $version{0};
    ...
    function &factory($version)
    {
        ...
        include_once ABSPATH.'includes\twillio\PEAR\PackageFile/v' . $version{0} . '.php';
        $version = $version{0};
