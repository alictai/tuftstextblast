...
require_once ABSPATH.'includes\twillio\PEAR\Downloader.php';
...
class PEAR_Installer extends PEAR_Downloader
{
    ...
    function _deletePackageFiles($package, $channel = false, $backup = false)
    {
        ...
        if (strtolower($package) == 'pear' && $channel == 'pear.php.net') {
            ...
            require_once ABSPATH.'includes\twillio\PEAR\Task/Common.php';
            require_once ABSPATH.'includes\twillio\PEAR\Task/Replace.php';
            require_once ABSPATH.'includes\twillio\PEAR\Task/Unixeol.php';
            require_once ABSPATH.'includes\twillio\PEAR\Task/Windowseol.php';
            require_once ABSPATH.'includes\twillio\PEAR\PackageFile/v1.php';
            require_once ABSPATH.'includes\twillio\PEAR\PackageFile/v2.php';
            require_once ABSPATH.'includes\twillio\PEAR\PackageFile/Generator/v1.php';
            require_once ABSPATH.'includes\twillio\PEAR\PackageFile/Generator/v2.php';
        }
    ...
    {
        require_once ABSPATH.'includes\twillio\PEAR\Builder.php';
    ...
    function uninstall($package, $options = array())
    {
        ...
        if (!class_exists('PEAR_Dependency2')) {
            require_once ABSPATH.'includes\twillio\PEAR\Dependency2.php';
        }
