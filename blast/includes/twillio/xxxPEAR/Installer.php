...
class PEAR_Installer extends PEAR_Downloader
{
    ...
    function _deletePackageFiles($package, $channel = false, $backup = false)
    {
        ...
        if (strtolower($package) == 'pear' && $channel == 'pear.php.net') {
            ...
            require_once 'Task/Common.php';
            require_once 'Task/Replace.php';
            require_once 'Task/Unixeol.php';
            require_once 'Task/Windowseol.php';
            require_once 'PackageFile/v1.php';
            require_once 'PackageFile/v2.php';
            require_once 'PackageFile/Generator/v1.php';
            require_once 'PackageFile/Generator/v2.php';
        }
