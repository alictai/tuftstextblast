...
array(
    ...
    array(
        ...
        PEAR_PACKAGEFILEMANAGER2_NO_PHPCOMPATINFO =>
            'PHP_CompatInfo is not installed, cannot detect dependencies',
       ),
 ...
 * <code>
 * <?php
 * require_once('PackageFileManager2.php');
...
class PEAR_PackageFileManager2 extends PEAR_PackageFile_v2_rw
{
     ...
     *                     /path/to/pearcvs/PEAR_PackageFileManager where
     ...
     *                     plugin is located in PackageFileManager/Foo.php.
    ...
    function setOptions($options = array(), $internal = false)
    {
        ...
        $resource = 'PackageFileManager/' . ucfirst(strtolower($this->_options['filelistgenerator'])) . '.php';
    ...
    {
        include_once 'Installer/Role.php';
    ...
    {
        include_once 'Task/Replace/rw.php';
    ...
    function addWindowsEol($path)
    {
        ...
        include_once 'Task/Windowseol/rw.php';
        $l = null;
    ...
    function addUnixEol($path)
    {
        ...
        include_once 'Task/Unixeol/rw.php';
        $l = null;
    ...
    {
        include_once 'Task/Postinstallscript/rw.php';
    ...
    function &_getExistingPackageXML($path, $packagefile = 'package.xml', $options = array())
    {
        if (is_string($path) && is_dir($path)) {
            ...
            include_once 'PackageFile/Parser/v2.php';
