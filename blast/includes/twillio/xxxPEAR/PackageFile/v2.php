...
class PEAR_PackageFile_v2
{
    ...
    function analyzeSourceCode($file, $string = false)
    {
        if (!isset($this->_v2Validator) ||
            ...
            if (!class_exists('PEAR_PackageFile_v2_Validator')) {
                require_once 'PackageFile/v2/Validator.php';
            }
     ...
     * of the name with "-" replaced by "_" as in Task/mycustom/task.php makes class
    ...
    function getTask($task)
    {
        ...
        $fp = @fopen("Task/$taskfile.php", 'r', true);
        if ($fp) {
            fclose($fp);
            require_once "Task/$taskfile.php";
            return "PEAR_Task_$task";
        }
        return false;
    }
